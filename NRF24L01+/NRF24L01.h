...
typedef enum{
	nRF_PWR_MIN   = 0x00,	// -18 dbm
	nRF_PWR_MID_1 = 0x02,	// -12 dbm
	nRF_PWR_MID_2 = 0x04,	// -6 dbm
	nRF_PWR_MAX   = 0x06	// 0 dbm
}nRF_PWR_s;


typedef enum{
	nRF_D_RATE_MIN = 0x20,  // 250kbps
	nRF_D_RATE_MID = 0x00,	// 1Mbps
	nRF_D_RATE_MAX = 0x08	// 2Mbps
}nRF_D_RATE_s;

typedef enum{
	crc_none,       // crc disabled
	crc_1,			// 2 byte CRC enabled
	crc_2			// 2 byte CRC enabled
}nRF_CRC_t;
